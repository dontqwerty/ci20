...
- poly_2D_design_matrix: creates the design matrix
- plot_logreg: plots the results
...
def poly_2D_design_matrix(x1, x2, degree):
    """
    Creates the expanded design matrix with all polynoms of x1 and x2 up to degree
...
def plot_logreg(data, degree, theta, E_list):
    """
    Plots the results for the logistic regression exercice
